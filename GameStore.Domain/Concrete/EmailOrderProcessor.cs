...
namespace GameStore.Domain.Concrete
{
    public class EmailSettings
    {
        ...
        public string FileLocation = @"C:\Users\Tony\source\repos\GameStore\game_store_emails";
    }
        ...
        public void ProcessOrder(Cart cart, ShippingDetails shippingInfo)
        {
            using (var smtpClient = new SmtpClient())
            {
                ...
                StringBuilder body = new StringBuilder()
                    .AppendLine("New order had processed successfully")
                    .AppendLine("---")
                    .AppendLine("Products:");
                ...
                body.AppendFormat("Total price: {0:c}", cart.ComputeTotalValue())
                    ...
                    .AppendLine("---")
                    .AppendFormat("Gift Shell: {0}",
                        shippingInfo.GiftWrap ? "Yes" : "No");

                MailMessage mailMessage = new MailMessage(
                                       emailSettings.MailFromAddress,	// From
                                       emailSettings.MailToAddress,		// For
                                       "Новый заказ отправлен!",		// Topic
                                       body.ToString()); 				// Letter's body
